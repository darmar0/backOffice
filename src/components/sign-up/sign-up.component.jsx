...
import {createAuthUserWidthEmailAndPassword, createUserDocFromAuth} from "../../utils/firebase/firebase.utils";
...
const SignUp = () => {
    ...
    const handeleSubmit = async(event) => {
        ...
        try{
        const {user} = await createAuthUserWidthEmailAndPassword(email, password);
